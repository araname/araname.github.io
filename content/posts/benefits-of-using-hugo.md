...
date: 2019-09-30
modified: 2019-10-04
subtitle: "내가 아라로그를 플래인에서 휴고로 갈아태웁니다."
tags: ["휴고", "이점", "알림"]
author: "Myeongjin"
...
* 휴고는 `config.toml`를 읽어서 그것에 지정된 테마를 찾아서 테마의 템플릿과 그 템플릿을 덮어쓰는 그 사이트 자체의 템플릿을 이용하여 정적 html 파일 등 사이트 내용을 생성할 것이다.

이에 따라 내가 웹에서 중복되는 내용을 고치기 위해 그것을 이러한 html 파일마다 일일히 찾아서 고쳐야 하는 수고를 덜 수 있게 된다. 나는 그 점이 마음에 든다.

## 마치며
다음 게시물에서는 [내가 Git라는 버전 제어 체제를 이용하면서 얻는 이점](/post/2019-10-04-1)을 다루도록 하겠다.
